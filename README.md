...
export APT_REPO_URL_NVIDIA_CUDA_UBUNTU_RESOLUTE="http://${APT_CACHER_HOST}/nvidia-cuda-resolute"
export APT_REPO_URL_NVIDIA_CUDA_DEBIAN_TRIXIE="http://${APT_CACHER_HOST}/nvidia-cuda-trixie"
